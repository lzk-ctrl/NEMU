...
make_group(group1_b,
	...
	helper_fun opcode_table[256] = {
		...
		/* 0x54 */ push, push, push, push,
		/* 0x58 */ pop, pop, pop, pop,
		/* 0x5c */ pop, pop, pop, pop,
		/* 0x60 */ inv, inv, inv, inv,
		/* 0x64 */ inv, inv, operand_size, inv,
		/* 0x68 */ pushss_si_v, imul_i_rm2r_v, pushss_si_b, imul_si_rm2r_v,
		...
		/* 0xac */ lods_n_b, lods_n_v, scas_b, inv,
		...
		/* 0xc0 */ group2_i_b, group2_i_v, ret_n_v, ret_n_v,
